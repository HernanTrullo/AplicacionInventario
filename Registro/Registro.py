...
class WinRegistro(ttk.Frame):
    ...
    def create_widget(self):
        ...
        self.frame_opciones_registro = ttk.LabelFrame(self)
        
        
        self.lb_nombre = ttk.Label(self.frame_opciones_registro, text="Nombre", style="Custom.TLabel").grid(row=0, column=1, sticky="w")
        self.lb_apellido = ttk.Label(self.frame_opciones_registro, text="Apellido",style="Custom.TLabel").grid(row=1, column=1,sticky="w")
        self.lb_admin = ttk.Label(self.frame_opciones_registro, text="Es Admin",style="Custom.TLabel").grid(row=2, column=2,sticky="w")
        self.lb_user = ttk.Label(self.frame_opciones_registro, text="Usuario",style="Custom.TLabel").grid(row=3, column=1,sticky="w")
        self.lb_pass = ttk.Label(self.frame_opciones_registro, text="Contraseña",style="Custom.TLabel").grid(row=4, column=1,sticky="w")
        ...
        self.btn_registro = ttk.Button(self.frame_opciones_registro, text="Registrarse", command=self.registrar_usuario)
        self.btn_registro.grid(row=5, column=3, rowspan=2, sticky="nsew")
